...
url = 'https://inet.detik.com/consumer/d-4940656/terkecil-di-kelasnya-ini-keunggulan-ultra-screen-o-di-vivo-v19?tag_from=wp_widget_news'
article = Article(url)
article.download()
article.parse()
nltk.download('punkt')
