...
def cfg():
    ...
    train = '/home/minhaj/machine-learning/mysum2/dataset/train.jsonl'
    # path to dev oracle JSONL file
    # dev = None
    dev = '/home/minhaj/machine-learning/mysum2/dataset/dev.jsonl'
    # path to test oracle JSONL file
    test = '/home/minhaj/machine-learning/mysum2/dataset/cek.jsonl'
...
@ing.capture
def load_data(train,dev,test,step):
    return train,dev,test,step